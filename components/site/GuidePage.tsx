...
export function GuidePage() {
  ...
  return (
    <div className="homepage min-h-screen bg-[var(--site-bg)] text-[var(--site-text)] overflow-x-hidden selection:bg-[var(--accent)]/20">
      <Navbar />
      ...
      <AnimatePresence>
        {showTopBtn && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 p-3 rounded-[8px] bg-[var(--site-surface)] border border-[var(--site-border)] text-[var(--site-text)] shadow-2xl hover:bg-[var(--site-surface-hover)] transition-colors"
